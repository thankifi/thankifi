...
public class RetrieveByIdHandler : QueryHandler<RetrieveById, CategoryDetailDto?>
{
    ...
    public override async Task<CategoryDetailDto?> Handle(RetrieveById request, CancellationToken cancellationToken)
    {
