...
using Thankifi.Core.Domain.Import.Notification;
...
namespace Thankifi.Core.Domain.Import.Command.ImportGratitudes
{
    public class ImportGratitudesCommandHandler : IRequestHandler<ImportGratitudesCommand, Unit>
    {
        ...
        public ImportGratitudesCommandHandler(ILogger<ImportGratitudesCommandHandler> logger, IImporterService importerService, ThankifiDbContext context, IMediator mediator)
        {
            Logger = logger;
